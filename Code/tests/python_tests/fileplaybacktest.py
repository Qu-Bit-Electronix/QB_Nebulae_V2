...
itimescale = 0.5
atime = kres
asig mincer atime, iamp, kfreq, 1, ilock, 1024, 8
outs asig, asig
endin"""
...
channels = [ChannelUpdater(c, "amp", RandomLine(.4, .2)),
            ChannelUpdater(c, "freq", RandomLine(0, 2)),
            ChannelUpdater(c, "resonance", RandomLine(0.0, 1.0))]
